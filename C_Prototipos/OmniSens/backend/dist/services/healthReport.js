...
exports.sendNodeHealthReport = sendNodeHealthReport;
exports.startHealthReportScheduler = startHealthReportScheduler;
const db_1 = require("../config/db");
const telegramBot_1 = require("./telegramBot");
async function sendNodeHealthReport() {
    try {
        ...
        for (const dev of devices) {
            ...
            const latestTelemetry = await db_1.db.selectFrom('air_quality_data')
                .selectAll()
        ...
        await (0, telegramBot_1.sendTelegramAlert)(chatId, message);
...
function startHealthReportScheduler() {
