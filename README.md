...
Chat-GPT-Image-30-may-2025-19-56-52.png
...
Flujo de Datos
Los sensores captan variables ambientales.
Los datos viajan por LoRa a un microcontrolador concentrador, que se encarga a la vez de enviarlos por MQTT a un servidor remoto
El servidor analiza y devuelve ordenes para que los Controladores Edge accionen los actuadores.
El servidor almacena y muestra los datos en tiempo real, permitiendo monitoreo remoto y acciones automáticas.
